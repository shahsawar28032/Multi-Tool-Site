...
<body>
    ...
    <style>
        ...
        #themeToggle .bi-sun-fill {
            display: <?php echo ($theme === 'dark') ? 'inline-block' : 'none' ?>;
        }
        #themeToggle .bi-moon-fill {
            display: <?php echo ($theme === 'light') ? 'inline-block' : 'none' ?>;
        }
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="tools/standard-calculator.php">
                                    <i class="bi bi-calculator-fill me-2"></i>Standard Calculator
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/scientific-calculator.php">
                                    <i class="bi bi-calculator me-2"></i>Scientific Calculator
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/percentage-calculator.php">
                                    <i class="bi bi-percent me-2"></i>Percentage Calculator
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item" href="tools/age-calculator.php">
                                    <i class="bi bi-calendar-event me-2"></i>Age Calculator
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/bmi-calculator.php">
                                    <i class="bi bi-person-bounding-box me-2"></i>BMI Calculator
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/loan-emi-calculator.php">
                                    <i class="bi bi-cash-coin me-2"></i>Loan Calculator
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/unit-converter.php">
                                    <i class="bi bi-arrow-left-right me-2"></i>Unit Converter
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="tools/date-difference.php">
    ...
    <!-- Banner Section -->
    <section class="banner-section" style="position: relative; background: url('images/calc.jpg') no-repeat center center/cover; padding: 100px 0; text-align: center; color: #fff;">
        <!-- Black Overlay -->
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 1;"></div>

        <div class="container" style="position: relative; z-index: 2;">
            <h1 style="font-size: 48px; font-weight: bold; margin-bottom: 20px;">Your All-in-One Utility Toolkit</h1>
            <p style="font-size: 18px; margin: 20px auto; max-width: 800px;">
                Take control of your construction projects with your all-in-one utility toolkit. Instantly calculate materials for concrete, bricks, plaster, paint, flooring, steel, and excavation with precision. Save time, minimize errors, and plan every project efficiently—all in one convenient place.
            </p>
            <a class="nav-link" href="#contact" style="
                display: inline-block; 
                padding: 12px 30px; 
    ...
    <section id="about" class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="images/calc.jpg"  alt="About Us" class="img-fluid rounded shadow" style="height: 460px; ">
                </div>
                <div class="col-lg-6">
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5><a href="index.php" style="color: white; hover: white;"><i class="bi bi-tools me-2"></i>Multi-Tool Utility</a></h5>
                    <p class="mb-0" style="max-width: 350px;">Your go-to toolkit for accurate construction calculations. Plan smarter, save materials, and complete projects efficiently—fast and easy!</p>
                </div>
                <div class="col-md-3">
                    <h5>Quick Links</h5>
                    <ul class="list-unstyled">
                ...
                <div class="col-md-3">
                    <h5>Connect</h5>
                    <div class="footer-connect" style="margin-top: 20px; color: #fff;">
                        <p style="margin: 5px 0;">Address: Lalabad, Landhi, Karachi, Pakistan</p>
                        <p style="margin: 5px 0;">Email: shahsawarkhan28032@gmail.com</p>
                        <div style="margin-top: 5px;">
                            <a href="https://github.com/shahsawar28032" target="_blank" style="color: #fff; margin-right: 10px;">Github</a>
                            <a href="https://www.linkedin.com/in/shahsawar-khan-884351349/" target="_blank" style="color: #fff;">LinkedIn</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <p class="mb-0">&copy; <?php echo date("Y"); ?> Multi-Tool Utility. Build By Shahsawar Khan.</p>
            </div>
        </div>
    </footer>
